<!DOCTYPE html>
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed " dir="ltr" data-theme="theme-default" data-assets-path="{{ url('') }}/public/assets/admin/assets/" data-template="vertical-menu-template">
  <head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/bootstrap-select/bootstrap-select.css" />
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/select2/select2.css" />
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/flatpickr/flatpickr.css" />
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/typeahead-js/typeahead.css" />
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/tagify/tagify.css" />
    ...
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css">
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css">
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css">
    <link rel="stylesheet" href="{{ url('') }}/public/assets/admin/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css">
  </head>
  <style>
    .form-label.le {
	float: left;
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ url('') }}/public/assets/admin/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle">
                    </div>
                  </a>
