          ...
          <div class="card-body  mt-4" > 
            <form  method="POST" action="{{ $url }}" class="row g-3"> @csrf
                    <div class="row">
                        ...
                        {{-- <div class="col-md-12">
                            <label class="form-label" for="formValidationName">Privacy Policy Page Heading</label>
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="formValidationNamess">Privacy Policy Content</label>
